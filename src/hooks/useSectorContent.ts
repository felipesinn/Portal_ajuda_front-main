// // src/hooks/useSectorContent.ts
// import { useState, useEffect, useCallback, type Dispatch, type SetStateAction } from 'react'; // Importar 'Dispatch' e 'SetStateAction'
...
// // Opcional, mas recomendado para tipagem explícita do retorno do hook
// interface UseSectorContentResult {
//   contents: ContentItem[];
//   setContents: Dispatch<SetStateAction<ContentItem[]>>; // <--- ADICIONE ESTA LINHA AQUI
//   loading: boolean;
//   error: string | null;
//   fetchContents: () => Promise<void>;
//   getContentById: (id: string) => Promise<ContentItem | null>;
//   getContentsByType: (type: ContentType) => ContentItem[];
...
// export const useSectorContent = (sector: SectorType): UseSectorContentResult => { // <--- Adicione o tipo de retorno aqui
...
//   return {
//     contents,
//     setContents, // <--- ESTA É A LINHA QUE ESTAVA FALTANDO!
//     loading,
//     error,
//     fetchContents,
//     getContentById,
