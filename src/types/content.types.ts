...
export interface ContentAddition {
  ...
  title?: string;
  content: string;
  filePath?: string; // Caminho para a imagem, após o upload
  createdAt: string;
  createdByName?: string; // Ou creator: ContentCreator; se for mais detalhado
  type: ContentType; // Para distinguir se é texto ou foto, como no ContentAdditionForm
}